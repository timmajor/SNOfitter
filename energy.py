...
#"data/193ev_bulkleslies/PTDXI_FV____100000steps_1cones_allevents.root",
...
#"data/495ev_8B_lesliecomparison_b14/PTDXI_FV____100000steps_1cones_allevents.root",
"data/testingallPMT97/PTDXI_F_____100000steps_2cones_allevents.root"
]
cone_flat=[]
...
#        coneness[index]=1-allEventTree.mflatIntensity[index]-allEventTree.munknownIntensity[index]
        coneness[index]=np.sum([allEventTree.mconeIntensity_0[index],allEventTree.mconeIntensity_1[index]])
...
#        c0.Update()
#        c0.SaveAs(title+".png")
    cone_flat[-1] = ROOT.TGraph(len(variableDict["coneness"]["data"]),array("d",variableDict["coneness"]["data"]),array("d",variableDict["trueE"]["data"]))
...
#            print i
    ...
    cone_flat[-1].GetXaxis().SetLimits(0.0,100)
    cone_flat[-1].GetXaxis().SetTitle("cone intensity")
    cone_flat[-1].GetYaxis().SetRangeUser(0.0,20)
    cone_flat[-1].GetYaxis().SetTitle("true energy")
