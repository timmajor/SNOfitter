...
#fitFileName = "PTXIABGaCL_<NUMBEROFSTEPS>steps_1cones.root"
...
for dif in fileDifs:
    allFileName = dif + "_<NUMBEROFSTEPS>steps_<NUMBEROFCONES>cones_allevents.root"
    allFile = ROOT.TFile(allFileName, "read")
    ...
    variableDict={
        ...
        "beta14" : {"data" : allEventTree.beta14, "dmin":-.1, "dmax":1},
        ...
        "mconeAngle" : {"data" : allEventTree.mconeAngle, "dmin":.7, "dmax":.8},
        ...
        "malpha" : {"data" : allEventTree.malpha, "dmin":.7, "dmax":.8},
        "mtrms" : {"data" : allEventTree.mtrms, "dmin":0, "dmax":15},
        "mconeIntensity_0" : {"data" : allEventTree.mconeIntensity_0, "dmin":0, "dmax":100},
        "mconeIntensity_1" : {"data" : allEventTree.mconeIntensity_1, "dmin":0, "dmax":100},
        "mflatIntensity" : {"data" : allEventTree.mflatIntensity, "dmin":0, "dmax":20},
        "mleslieIntensity" : {"data" : allEventTree.mleslieIntensity, "dmin":0, "dmax":100},
        "munknownIntensity" : {"data" : allEventTree.munknownIntensity, "dmin":0, "dmax":100}
    }
    fxdivmx=np.zeros(<NUMBEROFEVENTS>,dtype=float)
    flat_div_cone_plus_flat=np.zeros(<NUMBEROFEVENTS>,dtype=float)
    ...
    for variable in ["mt","nPMTsTotal","trueE","beta14","nPMTsGood","mr","malpha","mr_x","fr_x_div_mr_x","fr","fr_y","fu_angle_0","fu_cos_0","fu_angle_1","fu_cos_1","fu_angle_2","fu_cos_2","mu_x_0","mu_y_0","mu_z_0","fr_x","mconeAngle","mlightSpeed","mconeIntensity_0","mflatIntensity","mleslieIntensity","munknownIntensity","mlightSpeed","dr","mtrms","flat_div_cone_plus_flat"]:
