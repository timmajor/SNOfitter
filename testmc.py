...
dataFile = ROOT.TFile("mc_iso_elec_013294_000_p10.root")
r = ROOT.gDirectory.Get("T3D/PMT3D/r")
r.x()
#nEvent = MCEvents.GetEntry(0)
#print MCEvents.fNCerenkov
#T3D = ROOT.gDirectory.Get("T3D")
#PMT3D = ROOT.gDirectory.Get("PMT3D")
#PMTr = ROOT.gDirectory.Get("r")
#print PMTr.GetEntries()
#nEvent = T3D.PMT3D.GetEntry(0)
#print PMTr.fX
#print MCEvents.nMCVXs[0]
